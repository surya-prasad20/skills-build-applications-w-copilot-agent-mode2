...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Create Activities
        Activity.objects.create(user=tony, type='Strength', duration=60, date=timezone.now().date())
        Activity.objects.create(user=steve, type='Cardio', duration=45, date=timezone.now().date())
